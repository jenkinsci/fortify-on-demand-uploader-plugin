...
public class ScanSummaryDTO {
    ...
    public int getScanTypeId() { return scanTypeId; }
    ...
    public int getAnalysisStatusTypeId() { return analysisStatusTypeId; }

    public String getAnalysisStatusType() { return analysisStatusType; }
    ...
    public int getIssueCountCritical() { return issueCountCritical; }

    public int getIssueCountHigh() { return issueCountHigh; }

    public int getIssueCountMedium() { return issueCountMedium; }

    public int getIssueCountLow() { return issueCountLow; }

    public int getStarRating() { return starRating; }

    public String getNotes() { return notes; }

    public boolean getIsFalsePositiveChallenge() { return isFalsePositiveChallenge; }

    public boolean getIsRemediationScan() { return isRemediationScan; }

    public int getEntitlementId() { return entitlementId; }

    public int getEntitlementUnitsConsumed() { return entitlementUnitsConsumed; }
    ...
    public int getScanMethodTypeId() { return scanMethodTypeId; }

    public String getScanMethodTypeName() { return scanMethodTypeName; }

    public String getScanTool() { return scanTool; }

    public String getScanToolVersion() { return scanToolVersion; }
}
